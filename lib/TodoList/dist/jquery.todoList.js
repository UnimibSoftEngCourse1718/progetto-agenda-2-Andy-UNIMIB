...
(function(factory){
    ...
    setup.listTemplate =
	`<div class="jquery-todolist ui-widget" style="display:none;">
	...
	.jquery-todolist .jquery-todolist-menu-actions .jquery-todolist-action{padding:.2em;display:inline-block}
	.jquery-todolist .jquery-todolist-menu-items{max-height:10em;overflow-y:auto;margin:2em 0em 1em}
	...
	.jquery-todolist .jquery-todolist-add{padding:1px 40px 1px 1px;position:relative;border:none}
	...
	.jquery-todolist .jquery-todolist-edit{position:relative}
	.jquery-todolist .jquery-todolist-edit-input{width:100%;padding-right:40px}
